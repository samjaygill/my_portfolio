...
import './css/footer.css'; // Ensure your styles are imported correctly
import { faEnvelopeOpen, faEnvelopeSquare, faSquareEnvelope } from '@fortawesome/free-solid-svg-icons';
