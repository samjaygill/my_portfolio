  ...
  return (
    <div class="container">
      <div class="imessage">
        ...
        {/* <p class="from-me">Great! Where would I find out more info about you?</p> */}
      </div>
    </div>
  );
};
